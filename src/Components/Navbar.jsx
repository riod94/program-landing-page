...
function Navbar(props) {
	...
	return (
		<header
			className={`z-50 sticky px-4 lg:px-8 ${containerClassName} ${
				scrollDirection === "down" && !toggle ? "-top-24" : "top-0"
			}`}
		>
			<nav className="py-4">
				<div className="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
					...
					<div className="flex items-center lg:hidden lg:order-2">
						<button
							...
							type="button"
							className="inline-flex items-center p-2 ml-1 text-sm rounded-lg lg:hidden hover:text-primary-500 focus:outline-none focus:ring-2 focus:ring-gray-200"
					...
					>
						<motion.div
							...
							transition={{ type: "just", duration: 0.7, delay: 0.13 }}
						>
